...
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     EXE_FILES => [q[bin/split10xsam.pl], q[bin/changeReadGroup.pl]]
#     INSTALLDIRS => q[site]
...
EXE_FILES = bin/changeReadGroup.pl bin/split10xsam.pl

pure_all :: $(INST_SCRIPT)/changeReadGroup.pl $(INST_SCRIPT)/split10xsam.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/changeReadGroup.pl $(INST_SCRIPT)/split10xsam.pl 
